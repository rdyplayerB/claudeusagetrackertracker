...
|------|-------|------|-------------|
| [Claude-Usage-Tracker](https://github.com/hamed-elfayome/Claude-Usage-Tracker) | 2226 | macos-app | Native macOS menu bar app for tracking Claude AI usage limits in real-time. Buil |
| [Claude-Usage-Extension](https://github.com/lugia19/Claude-Usage-Extension) | 272 | extension | Claude Usage Tracker browser extension |
...
| [claude-usage-tracker](https://github.com/eli-manning/claude-usage-tracker) | 3 | unknown | Claude usage tracker |
