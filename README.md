...
![Trackers Tracked](https://img.shields.io/badge/trackers_tracked-28-blue)

## The Trackers

| Name | Stars | Type | Description |
|------|-------|------|-------------|
| [Claude-Usage-Tracker](https://github.com/hamed-elfayome/Claude-Usage-Tracker) | 2317 | macos-app | Native macOS menu bar app for tracking Claude AI usage limits in real-time. Buil |
...
| [ClaudeUsageTracker](https://github.com/masorange/ClaudeUsageTracker) | 111 | macos-app | Track your Claude Code API usage from your macOS menu bar with accurate cost cal |
