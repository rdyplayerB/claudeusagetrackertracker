...
|------|-------|------|-------------|
| [Claude-Usage-Tracker](https://github.com/hamed-elfayome/Claude-Usage-Tracker) | 1942 | macos-app | Native macOS menu bar app for tracking Claude AI usage limits in real-time. Buil |
