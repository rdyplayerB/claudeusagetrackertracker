...
|------|-------|------|-------------|
| [Claude-Usage-Tracker](https://github.com/hamed-elfayome/Claude-Usage-Tracker) | 2294 | macos-app | Native macOS menu bar app for tracking Claude AI usage limits in real-time. Buil |
| [Claude-Usage-Extension](https://github.com/lugia19/Claude-Usage-Extension) | 284 | extension | Claude Usage Tracker browser extension |
...
| [claude-token-tracker](https://github.com/imwebdev/claude-token-tracker) | 2 | unknown |  |
