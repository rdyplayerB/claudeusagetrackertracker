...
|------|-------|------|-------------|
| [Claude-Usage-Tracker](https://github.com/hamed-elfayome/Claude-Usage-Tracker) | 3191 | macos-app | Native macOS menu bar app for tracking Claude AI usage limits in real-time. Buil |
