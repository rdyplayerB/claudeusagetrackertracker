...
![Trackers Tracked](https://img.shields.io/badge/trackers_tracked-46-blue)

## The Trackers

| Name | Stars | Type | Description |
|------|-------|------|-------------|
| [Claude-Usage-Tracker](https://github.com/hamed-elfayome/Claude-Usage-Tracker) | 3234 | macos-app | Native macOS menu bar app for tracking Claude AI usage limits in real-time. Buil |
| [Claude-Usage-Extension](https://github.com/lugia19/Claude-Usage-Extension) | 400 | extension | Claude Usage Tracker browser extension |
| [ClaudeUsageTracker](https://github.com/masorange/ClaudeUsageTracker) | 117 | macos-app | Track your Claude Code API usage from your macOS menu bar with accurate cost cal |
