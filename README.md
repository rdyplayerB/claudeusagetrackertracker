...
![Trackers Tracked](https://img.shields.io/badge/trackers_tracked-54-blue)

## The Trackers

| Name | Stars | Type | Description |
|------|-------|------|-------------|
| [Claude-Usage-Tracker](https://github.com/hamed-elfayome/Claude-Usage-Tracker) | 3563 | macos-app | Native macOS menu bar app for tracking Claude AI usage limits in real-time. Buil |
| [Claude-Usage-Extension](https://github.com/lugia19/Claude-Usage-Extension) | 436 | extension | Claude Usage Tracker browser extension |
...
| [Claude-Usage-Tracker-Extension](https://github.com/Himal-Joshi/Claude-Usage-Tracker-Extension) | 14 | unknown | Claude Usage Tracker Extension a privacy-first browser tool for real-time token  |
| [ClaudeQuota](https://github.com/Dickie2306/ClaudeQuota) | 14 | unknown | Live Claude usage tracking (session & weekly limits) in your macOS menu bar at a |
| [Claude-Usage-Tracker-and-Prompt-Optimization-Extension](https://github.com/B-Sheikh/Claude-Usage-Tracker-and-Prompt-Optimization-Extension) | 12 | unknown |  |
| [claude-meter](https://github.com/JackBhanded/claude-meter) | 12 | unknown | Windows taskbar widget for live Claude usage tracking. Per-model breakdown, rese |
| [claude-token-tracker](https://github.com/pepperonas/claude-token-tracker) | 11 | dashboard | Token usage dashboard for Claude Code |
| [claude-usage-tracker](https://github.com/therohanparmar/claude-usage-tracker) | 10 | unknown | Browser extension that shows your Claude usage limits in the toolbar - live badg |
| [claude-code-usage-analytics](https://github.com/wangtae/claude-code-usage-analytics) | 6 | unknown | Multi-device usage monitoring dashboard for Claude Code |
| [tokenflow](https://github.com/fardeen-fhr/tokenflow) | 6 | unknown | Local-first Claude usage tracker and task queue. |
...
| [CC-Tracker](https://github.com/AUCB21/CC-Tracker) | 3 | unknown | Local middleware for Claude Code — tracks sessions, plans, tasks, prompts, tool  |
| [claude-usage-tracker](https://github.com/jimdawdy-hub/claude-usage-tracker) | 3 | unknown | Local dashboard for tracking Claude Code and Claude.ai usage across multiple mac |
...
| [Claude-Token-Tracker](https://github.com/ColinM-sys/Claude-Token-Tracker) | 2 | unknown | Local web dashboard for tracking Claude Code token usage and costs |
