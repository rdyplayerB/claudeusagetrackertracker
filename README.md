...
![Trackers Tracked](https://img.shields.io/badge/trackers_tracked-41-blue)

## The Trackers

| Name | Stars | Type | Description |
|------|-------|------|-------------|
| [Claude-Usage-Tracker](https://github.com/hamed-elfayome/Claude-Usage-Tracker) | 3058 | macos-app | Native macOS menu bar app for tracking Claude AI usage limits in real-time. Buil |
| [Claude-Usage-Extension](https://github.com/lugia19/Claude-Usage-Extension) | 386 | extension | Claude Usage Tracker browser extension |
...
| [ClaudeQuota](https://github.com/Dickie2306/ClaudeQuota) | 10 | unknown | Live Claude usage tracking (session & weekly limits) in your macOS menu bar at a |
