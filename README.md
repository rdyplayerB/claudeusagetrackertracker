...
![Trackers Tracked](https://img.shields.io/badge/trackers_tracked-47-blue)

## The Trackers

| Name | Stars | Type | Description |
|------|-------|------|-------------|
| [Claude-Usage-Tracker](https://github.com/hamed-elfayome/Claude-Usage-Tracker) | 3307 | macos-app | Native macOS menu bar app for tracking Claude AI usage limits in real-time. Buil |
| [Claude-Usage-Extension](https://github.com/lugia19/Claude-Usage-Extension) | 406 | extension | Claude Usage Tracker browser extension |
...
| [claude-usage-tracker](https://github.com/brunellegrossmann/claude-usage-tracker) | 3 | unknown | Tracks Claude Code usage costs |
